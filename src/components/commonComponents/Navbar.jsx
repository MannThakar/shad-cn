      ...
      <nav className="w-full bg-white fixed">
        <div className="container mx-auto flex items-center justify-between px-4 py-6">
          ...
          <button
            ...
            className="bg-[#09c3823b] p-3 rounded-full cursor-pointer"
          >
